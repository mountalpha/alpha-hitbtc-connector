...
const (
	API_BASE = "https://api.hitbtc.com/api/3" // HitBtc API endpoint
)
...
func (b *HitBtc) GetCurrencies() (currencies map[string]Currency, err error) {
...
func (b *HitBtc) GetSymbols() (symbols map[string]Symbol, err error) {
